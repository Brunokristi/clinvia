...
<template>
    <EventDialog
        ...
        width="max-w-3xl"
        date-id="rule_date"
        starts-at-id="rule_starts_at"
        ends-at-id="rule_ends_at"
        save-label="Uložiť"
        :loading="loading"
        ...
        delete-dialog-title="Vymazať pravidlo rezervácií"
        delete-dialog-description="Vyberte rozsah odstránenia pravidla rezervácií."
        delete-one-label="Odstrániť iba tento termín"
        delete-future-label="Odstrániť od tohto termínu ďalej"
        delete-all-label="Odstrániť celé pravidlo"
        @close="closeDialog"
        @save="emit('save')"
    ...
    >
        <div v-if="currentRule" class="space-y-6">
            ...
            >
                <FormField label="Ako chcete spravovať tento čas?" for="slot_mode">
                    <Select
                        id="slot_mode"
            ...
            >
                <FormField label="Služba" for="single_service_id" required>
                    <Select
                ...
                <FormField label="Počet rezervovateľných miest" for="bookable_places" required>
                    <InputNumber
                        id="bookable_places"
            ...
            <FormSection
                ...
                columns="md:grid-cols-1"
            >
                <FormField label="Rezervovateľné služby" for="service_ids" required>
                    <MultiSelect
                        id="service_ids"
